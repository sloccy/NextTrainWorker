/**
 * Binary encoding/decoding for the arrivals wire formats.
 *
 * arrivals/current.bin layout (Stored in R2, patched each cron tick by Worker):
 *   [u32 generated_at]
 ...
 *
 * arrivals/stations.bin (Stored in R2, generated by GitHub Actions):
